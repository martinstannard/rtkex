...
* **mix:** Elixir Mix integration — `rtk mix test/compile/credo/phx.routes/ash.codegen` with 90%/85%/80%/70%/88% token savings respectively; priority-aware credo filtering, migration-SQL-only ash.codegen output, failures-only test runner
